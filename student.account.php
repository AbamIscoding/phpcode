...
<div class="action-container">
  ...
  <a class="button create-account-link" href="create.studacc.php">Create New Student Account</a>
    ...
    <?php
      function buildtable($result){
        if(mysqli_num_rows($result)>0){
          echo "<table>";
          echo "<tr>";
          echo "<th>Student Number</th><th>Last Name</th><th>First Name</th><th>Middle Name</th><th>Course</th><th>Year Level</th><th>Created By</th><th>Date Created</th><th>Actions</th>";
          echo "</tr>";
          echo "<br>";
          while($row = mysqli_fetch_array($result)){
            ...
            echo "<td>";
            echo "<a href='update.studacc.php?Username=" . $row['studentnumber'] . "'>Update</a>";
            echo "<span style='margin: 0 5px;'>|</span>";
            echo "<button onclick='confirmDelete(\"" . $row['studentnumber'] . "\")'>Delete</button>";
            echo "</td>";
            echo "</tr>";
          }
          echo "</table>";
      ...
      if(isset($_POST['btnsearch'])){
        $sql = "SELECT * FROM tblstudent WHERE Studentnumber LIKE ? OR Lastname LIKE ? ORDER BY Studentnumber";
  ...
  <footer>
    ...
    <script>
        function confirmDelete(studentnumber) {
            var result = confirm("Are you sure you want to delete \"" + studentnumber + "\"?");
            if (result) {
                var xhr = new XMLHttpRequest();
                xhr.open("POST", "delete.studacc.php", true);
                ...
                xhr.send("confirm=yes&txtstudent=" + studentnumber);
            } else {
...
.action-container .search-box {
  display: flex;
  align-items: center;
  margin-right: 325px; /* Add margin to the right */
}

...
<html>
<head>
  <title>View Subjects - Arellano University Subject Advising System - AUSAS</title>
...
<div class="action-container">
  <div class="menu-container">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        <a href="..\database\view.grades.php">View Grades</a>
      </div>
    </div>
  </div>
</div>
...
if(isset($_SESSION['Username'])){
    $student_number = $_SESSION['Username']; // Assuming the student number is stored in the 'Username' session variable
    
    // Retrieve student details based on session
...
<footer>
  ...
  <style>
    ...
    main {
      ...
      padding-bottom: 50px; /* Adjusted padding to accommodate footer */
